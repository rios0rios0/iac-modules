...
- Terraform: 1.16.2 (AWS image), 1.6.3 (Azure image)
- Terragrunt: 0.53.2
...
- `checks.yaml` — runs on pull requests targeting `main` via `rios0rios0/pipelines`; the shared checks job, granted `contents: read` per job.
